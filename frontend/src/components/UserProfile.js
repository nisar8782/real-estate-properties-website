            ...
            {data && <div className={classes.main}>
                ...
                <div className={classes['agent-profile']}>
                    <div className={classes['agent-profile-img']}>
                        {data.photoURL && <img src={data.photoURL} alt="" />}
                        {!data.photoURL && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <button className={classes['edit-profile']}><Link to="/profile/edit">Edit Profile</Link></button>
                </div>
